...
export default function CreditoLancamentos({
  navigation,
  route,
}: RootStackScreenProps<"CreditoLancamentos">) {
  const meses = [
    "Jan",
    "Fev",
    "Mar",
  ...
  return (
    <ScrollView contentContainerStyle={{ alignItems: "center" }}>
      ...
      <Botao cor="verde" tipo="grande" style={estilos.botao} onPress={() => navigation.navigate('CadastroLancamentoCredito', {id: id})}>Cadastrar novo lançamento</Botao>
    </ScrollView>
  );
}
