    ...
    <SafeAreaView style={estilos.container}>
      <View  style={estilos.tipoDebito}>
        ...
        <View style={estilos.detalhesContainer}>
            ...
            <Texto style={estilos.texto16}>Parcela:</Texto>
            <Texto style={[estilos.texto16, { marginBottom: 10 }]}>Única</Texto>
        ...
        <View style={estilos.areaBotao}>
          ...
          onPress={() => navigation.navigate('EdicaoLancamentoDebito',{lancamento: lancamento})}>
